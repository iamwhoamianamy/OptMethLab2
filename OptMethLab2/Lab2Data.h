...
double neg_f3(const vector<double>& x)
{
   return -f3(x);
}
...
//// Поиск аргумента минимума функции вдоль направления методом парабол
//int FindMinArgParabola(double funct(const vector<double>&),
//                       const vector<double>& x, const vector<double>& Sk, const double& eps, double& result)
//{
//
//}